...
public class ParticleUtils {
   ...
   public static void spawnParticlesOnBlockFace(Level pLevel, BlockPos pPos, ParticleOptions pParticle, IntProvider pCount, Direction pDirection, Supplier<Vec3> p_216324_, double p_216325_) {
      int i = pCount.sample(pLevel.random);

      for(int j = 0; j < i; ++j) {
         spawnParticleOnFace(pLevel, pPos, pDirection, pParticle, p_216324_.get(), p_216325_);
      }
   ...
   public static void spawnParticleOnFace(Level pLevel, BlockPos pPos, Direction pDirection, ParticleOptions pParticle, Vec3 p_216311_, double p_216312_) {
      Vec3 vec3 = Vec3.atCenterOf(pPos);
