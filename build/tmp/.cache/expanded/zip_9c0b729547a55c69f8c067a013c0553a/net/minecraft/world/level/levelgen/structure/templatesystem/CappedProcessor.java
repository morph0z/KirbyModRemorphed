...
public class CappedProcessor extends StructureProcessor {
   ...
   public final List<StructureTemplate.StructureBlockInfo> finalizeProcessing(ServerLevelAccessor pServerLevel, BlockPos p_278055_, BlockPos p_277825_, List<StructureTemplate.StructureBlockInfo> p_277746_, List<StructureTemplate.StructureBlockInfo> p_277676_, StructurePlaceSettings pSettings) {
      if (this.limit.getMaxValue() != 0 && !p_277676_.isEmpty()) {
         if (p_277746_.size() != p_277676_.size()) {
            ...
            RandomSource randomsource = RandomSource.create(pServerLevel.getLevel().getSeed()).forkPositional().at(p_278055_);
            ...
            if (i < 1) {
               ...
               while(intiterator.hasNext() && j < i) {
                  ...
                  StructureTemplate.StructureBlockInfo structuretemplate$structureblockinfo2 = this.delegate.processBlock(pServerLevel, p_278055_, p_277825_, structuretemplate$structureblockinfo, structuretemplate$structureblockinfo1, pSettings);
