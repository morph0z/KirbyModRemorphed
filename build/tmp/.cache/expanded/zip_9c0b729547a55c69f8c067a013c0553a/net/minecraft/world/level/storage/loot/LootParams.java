...
public class LootParams {
   ...
   public static class Builder {
      ...
      public <T> LootParams.Builder withParameter(LootContextParam<T> pParameter, T p_287606_) {
         this.params.put(pParameter, p_287606_);
         return this;
      }

      public <T> LootParams.Builder withOptionalParameter(LootContextParam<T> pParameter, @Nullable T p_287630_) {
         if (p_287630_ == null) {
            this.params.remove(pParameter);
         } else {
            this.params.put(pParameter, p_287630_);
         }
