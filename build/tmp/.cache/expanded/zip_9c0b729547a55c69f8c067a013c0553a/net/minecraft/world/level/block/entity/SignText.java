...
public class SignText {
   ...
   public FormattedCharSequence[] getRenderMessages(boolean pRenderMessagedFiltered, Function<Component, FormattedCharSequence> p_277538_) {
      if (this.renderMessages == null || this.renderMessagedFiltered != pRenderMessagedFiltered) {
         ...
         for(int i = 0; i < 4; ++i) {
            this.renderMessages[i] = p_277538_.apply(this.getMessage(i, pRenderMessagedFiltered));
         }
      }
