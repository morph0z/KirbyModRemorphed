...
public class SurfaceSystem {
   ...
   private void frozenOceanExtension(int p_189935_, Biome pBiome, BlockColumn p_189937_, BlockPos.MutableBlockPos p_189938_, int pX, int pZ, int p_189941_) {
      double d0 = 1.28D;
   ...
   private static void makeBands(RandomSource pRandom, BlockState[] p_224645_, int p_224646_, BlockState p_224647_) {
      int i = pRandom.nextIntBetweenInclusive(6, 15);

      for(int j = 0; j < i; ++j) {
         int k = p_224646_ + pRandom.nextInt(3);
         int l = pRandom.nextInt(p_224645_.length);
