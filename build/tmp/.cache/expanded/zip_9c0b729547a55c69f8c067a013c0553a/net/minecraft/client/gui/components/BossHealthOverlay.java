...
public class BossHealthOverlay {
   ...
   private void drawBar(GuiGraphics pGuiGraphics, int pX, int pY, BossEvent pBossEvent, int p_283619_, int p_281636_) {
      pGuiGraphics.blit(GUI_BARS_LOCATION, pX, pY, 0, pBossEvent.getColor().ordinal() * 5 * 2 + p_281636_, p_283619_, 5);
      if (pBossEvent.getOverlay() != BossEvent.BossBarOverlay.PROGRESS) {
         RenderSystem.enableBlend();
         pGuiGraphics.blit(GUI_BARS_LOCATION, pX, pY, 0, 80 + (pBossEvent.getOverlay().ordinal() - 1) * 5 * 2 + p_281636_, p_283619_, 5);
