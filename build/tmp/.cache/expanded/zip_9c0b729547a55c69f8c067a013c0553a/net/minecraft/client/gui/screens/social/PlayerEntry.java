...
public class PlayerEntry extends ContainerObjectSelectionList.Entry<PlayerEntry> {
   ...
   public void render(GuiGraphics pGuiGraphics, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean p_281660_, float pPartialTick) {
      int i = pLeft + 4;
