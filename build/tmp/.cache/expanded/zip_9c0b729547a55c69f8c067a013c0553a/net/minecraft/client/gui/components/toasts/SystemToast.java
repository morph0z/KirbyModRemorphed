...
public class SystemToast implements Toast {
   ...
   private void renderBackgroundRow(GuiGraphics pGuiGraphics, ToastComponent pToastComponent, int p_281750_, int p_282371_, int p_283613_, int p_282880_) {
      ...
      for(int k = i; k < p_281750_ - j; k += 64) {
         pGuiGraphics.blit(TEXTURE, k, p_283613_, 32, 64 + p_282371_, Math.min(64, p_281750_ - k - j), p_282880_);
      }

      pGuiGraphics.blit(TEXTURE, p_281750_ - j, p_283613_, 160 - j, 64 + p_282371_, j, p_282880_);
   }
