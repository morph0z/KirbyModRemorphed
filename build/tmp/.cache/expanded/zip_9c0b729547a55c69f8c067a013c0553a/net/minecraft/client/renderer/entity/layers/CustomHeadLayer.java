   ...
   public void render(PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight, T pLivingEntity, float pLimbSwing, float pLimbSwingAmount, float pPartialTicks, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
      ...
      if (!itemstack.isEmpty()) {
         ...
         if (pLivingEntity.isBaby() && !(pLivingEntity instanceof Villager)) {
            float f = 2.0F;
            float f1 = 1.4F;
            pMatrixStack.translate(0.0F, 0.03125F, 0.0F);
         ...
         if (item instanceof BlockItem && ((BlockItem)item).getBlock() instanceof AbstractSkullBlock) {
            ...
            if (flag) {
               pMatrixStack.translate(0.0F, 0.0625F, 0.0F);
            }
            ...
            SkullBlockRenderer.renderSkull((Direction)null, 180.0F, f3, pMatrixStack, pBuffer, pPackedLight, skullmodelbase, rendertype);
         } else {
            label60: {
               ...
               this.itemInHandRenderer.renderItem(pLivingEntity, itemstack, ItemDisplayContext.HEAD, false, pMatrixStack, pBuffer, pPackedLight);
            }
         }
