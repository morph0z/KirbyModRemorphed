   ...
   public void render(PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight, T pLivingEntity, float pLimbSwing, float pLimbSwingAmount, float pPartialTicks, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
      if (!pLivingEntity.isBaby()) {
         ...
         if (!pLivingEntity.isInvisible() || flag) {
            ...
            pMatrixStack.translate(0.2F, -0.35F, 0.5F);
            pMatrixStack.mulPose(Axis.YP.rotationDegrees(-48.0F));
            ...
            pMatrixStack.pushPose();
            pMatrixStack.translate(0.2F, -0.35F, 0.5F);
            pMatrixStack.mulPose(Axis.YP.rotationDegrees(42.0F));
            pMatrixStack.translate(0.1F, 0.0F, -0.6F);
            pMatrixStack.mulPose(Axis.YP.rotationDegrees(-48.0F));
            pMatrixStack.scale(-1.0F, -1.0F, 1.0F);
            pMatrixStack.translate(-0.5F, -0.5F, -0.5F);
            this.renderMushroomBlock(pMatrixStack, pBuffer, pPackedLight, flag, blockstate, i, bakedmodel);
            ...
            pMatrixStack.translate(0.0F, -0.7F, -0.2F);
            pMatrixStack.mulPose(Axis.YP.rotationDegrees(-78.0F));
            pMatrixStack.scale(-1.0F, -1.0F, 1.0F);
            pMatrixStack.translate(-0.5F, -0.5F, -0.5F);
            this.renderMushroomBlock(pMatrixStack, pBuffer, pPackedLight, flag, blockstate, i, bakedmodel);
            pMatrixStack.popPose();
