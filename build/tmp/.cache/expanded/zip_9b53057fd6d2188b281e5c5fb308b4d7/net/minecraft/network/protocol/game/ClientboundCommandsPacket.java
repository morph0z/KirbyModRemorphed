...
public class ClientboundCommandsPacket implements Packet<ClientGamePacketListener> {
   ...
   private static ClientboundCommandsPacket.Entry createEntry(CommandNode<SharedSuggestionProvider> pNode, Object2IntMap<CommandNode<SharedSuggestionProvider>> p_237623_) {
      int i = 0;
      int j;
      if (pNode.getRedirect() != null) {
         i |= 8;
         j = p_237623_.getInt(pNode.getRedirect());
      } else {
         j = 0;
      }
      ...
      int[] aint = pNode.getChildren().stream().mapToInt(p_237623_::getInt).toArray();
