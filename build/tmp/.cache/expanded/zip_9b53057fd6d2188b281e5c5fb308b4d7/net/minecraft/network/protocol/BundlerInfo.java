...
public interface BundlerInfo {
   ...
   static <T extends PacketListener, P extends BundlePacket<T>> BundlerInfo createForPacket(final Class<P> pPacketClass, final Function<Iterable<Packet<T>>, P> p_265627_, final BundleDelimiterPacket<T> pPacket) {
