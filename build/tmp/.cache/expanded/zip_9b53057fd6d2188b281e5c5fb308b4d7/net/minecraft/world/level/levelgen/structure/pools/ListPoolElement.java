...
public class ListPoolElement extends StructurePoolElement {
   ...
   public boolean place(StructureTemplateManager pStructureTemplateManager, WorldGenLevel pLevel, StructureManager pStructureManager, ChunkGenerator pGenerator, BlockPos p_227276_, BlockPos p_227277_, Rotation pRotation, BoundingBox pBox, RandomSource pRandom, boolean p_227281_) {
      for(StructurePoolElement structurepoolelement : this.elements) {
         if (!structurepoolelement.place(pStructureTemplateManager, pLevel, pStructureManager, pGenerator, p_227276_, p_227277_, pRotation, pBox, pRandom, p_227281_)) {
            return false;
         }
      }
