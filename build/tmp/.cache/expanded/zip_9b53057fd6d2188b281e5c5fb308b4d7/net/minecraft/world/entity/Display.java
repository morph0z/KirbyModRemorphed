...
public abstract class Display extends Entity {
   ...
   public static class TextDisplay extends Display {
      ...
      private static byte loadFlag(byte p_270219_, CompoundTag pTag, String pFlag, byte p_270701_) {
         return pTag.getBoolean(pFlag) ? (byte)(p_270219_ | p_270701_) : p_270219_;
      }
      ...
      private static void storeFlag(byte p_270879_, CompoundTag pTag, String pFlag, byte p_270853_) {
         pTag.putBoolean(pFlag, (p_270879_ & p_270853_) != 0);
      }
