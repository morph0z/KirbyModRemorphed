...
public class FixedBiomeSource extends BiomeSource implements BiomeManager.NoiseBiomeSource {
   ...
   @Nullable
   public Pair<BlockPos, Holder<Biome>> findClosestBiome3d(BlockPos pPos, int p_220651_, int p_220652_, int p_220653_, Predicate<Holder<Biome>> pBiomePredicate, Climate.Sampler pSampler, LevelReader pLevel) {
