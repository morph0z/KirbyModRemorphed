...
public class BlobFoliagePlacer extends FoliagePlacer {
   ...
   protected static <P extends BlobFoliagePlacer> Products.P3<RecordCodecBuilder.Mu<P>, IntProvider, IntProvider, Integer> blobParts(RecordCodecBuilder.Instance<P> pCodecBuilder) {
      return foliagePlacerParts(pCodecBuilder).and(Codec.intRange(0, 16).fieldOf("height").forGetter((p_68412_) -> {
