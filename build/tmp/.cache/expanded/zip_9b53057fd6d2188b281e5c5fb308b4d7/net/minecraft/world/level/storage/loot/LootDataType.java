...
public class LootDataType<T> {
   ...
   public void runValidation(ValidationContext pContext, LootDataId<T> pId, T p_279124_) {
      this.validator.run(pContext, pId, p_279124_);
   }
   ...
   public interface Validator<T> {
      void run(ValidationContext pContext, LootDataId<T> pId, T p_279326_);
   }
}
