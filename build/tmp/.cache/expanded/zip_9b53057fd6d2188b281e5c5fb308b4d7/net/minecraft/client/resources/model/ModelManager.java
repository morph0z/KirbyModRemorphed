...
public class ModelManager implements PreparableReloadListener, AutoCloseable {
   ...
   private ModelManager.ReloadState loadModels(ProfilerFiller pProfilerFiller, Map<ResourceLocation, AtlasSet.StitchResult> p_250646_, ModelBakery pModelBakery) {
      ...
      return new ModelManager.ReloadState(pModelBakery, bakedmodel, map1, p_250646_, completablefuture);
   }

   private void apply(ModelManager.ReloadState pReloadState, ProfilerFiller pProfilerFiller) {
      pProfilerFiller.startTick();
      pProfilerFiller.push("upload");
