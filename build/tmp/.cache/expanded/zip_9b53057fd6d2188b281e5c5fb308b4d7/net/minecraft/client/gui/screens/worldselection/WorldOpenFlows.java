...
public class WorldOpenFlows {
   ...
   public static void confirmWorldCreation(Minecraft pMinecraft, CreateWorldScreen pScreen, Lifecycle pLifecycle, Runnable pLoadWorld, boolean p_270709_) {
      ...
      if (!p_270709_ && pLifecycle != Lifecycle.stable()) {
