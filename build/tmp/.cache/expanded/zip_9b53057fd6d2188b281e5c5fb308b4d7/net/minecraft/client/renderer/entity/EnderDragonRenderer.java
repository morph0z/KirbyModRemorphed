...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon> {
   ...
   public static void renderCrystalBeams(float p_114188_, float p_114189_, float p_114190_, float p_114191_, int p_114192_, PoseStack pPoseStack, MultiBufferSource pBuffer, int p_114195_) {
      ...
      pPoseStack.mulPose(Axis.YP.rotation((float)(-Math.atan2((double)p_114190_, (double)p_114188_)) - ((float)Math.PI / 2F)));
      pPoseStack.mulPose(Axis.XP.rotation((float)(-Math.atan2((double)f, (double)p_114189_)) - ((float)Math.PI / 2F)));
