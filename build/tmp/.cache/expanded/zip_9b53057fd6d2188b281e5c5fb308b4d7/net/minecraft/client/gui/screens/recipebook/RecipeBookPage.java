...
public class RecipeBookPage {
   ...
   public void render(GuiGraphics pGuiGraphics, int p_281888_, int p_281904_, int pMouseX, int pMouseY, float pPartialTick) {
      if (this.totalPages > 1) {
         String s = this.currentPage + 1 + "/" + this.totalPages;
         int i = this.minecraft.font.width(s);
         pGuiGraphics.drawString(this.minecraft.font, s, p_281888_ - i / 2 + 73, p_281904_ + 141, -1, false);
      }
