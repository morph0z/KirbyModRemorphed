...
public class SupportBlockRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   private void drawHighlights(PoseStack pPoseStack, MultiBufferSource pBuffer, double pCamX, double pCamY, double pCamZ, Entity pEntity, DoubleSupplier p_286458_, float pRed, float pGreen, float pBlue) {
   ...
   private void highlightPosition(BlockPos pPos, PoseStack pPoseStack, double pCamX, double pCamY, double pCamZ, MultiBufferSource pBuffer, double p_286880_, float pRed, float pGreen, float pBlue) {
      double d0 = (double)pPos.getX() - pCamX - 2.0D * p_286880_;
      double d1 = (double)pPos.getY() - pCamY - 2.0D * p_286880_;
      double d2 = (double)pPos.getZ() - pCamZ - 2.0D * p_286880_;
