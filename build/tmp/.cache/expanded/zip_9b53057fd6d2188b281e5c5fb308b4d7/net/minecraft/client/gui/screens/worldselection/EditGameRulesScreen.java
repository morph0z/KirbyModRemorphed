...
public class EditGameRulesScreen extends Screen {
   ...
   public class BooleanRuleEntry extends EditGameRulesScreen.GameRuleEntry {
      ...
      public void render(GuiGraphics pGuiGraphics, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean p_283227_, float pPartialTick) {
   ...
   public class CategoryRuleEntry extends EditGameRulesScreen.RuleEntry {
      ...
      public void render(GuiGraphics pGuiGraphics, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean p_283421_, float pPartialTick) {
   ...
   public class IntegerRuleEntry extends EditGameRulesScreen.GameRuleEntry {
      ...
      public void render(GuiGraphics pGuiGraphics, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean p_282227_, float pPartialTick) {
         this.renderLabel(pGuiGraphics, pTop, pLeft);
