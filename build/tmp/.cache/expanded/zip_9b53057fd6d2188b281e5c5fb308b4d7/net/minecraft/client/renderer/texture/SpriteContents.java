...
public class SpriteContents implements Stitcher.Entry, AutoCloseable {
    ...
    */
   @Deprecated
   public SpriteContents(ResourceLocation pName, FrameSize pFrameSize, NativeImage pOriginalImage, AnimationMetadataSection p_250432_) {
      this(pName, pFrameSize, pOriginalImage, p_250432_, null);
   }

   public SpriteContents(ResourceLocation pName, FrameSize pFrameSize, NativeImage pOriginalImage, AnimationMetadataSection p_250432_, @org.jetbrains.annotations.Nullable net.minecraftforge.client.textures.ForgeTextureMetadata forgeMeta) {
      this.name = pName;
      this.width = pFrameSize.width();
      this.height = pFrameSize.height();
      this.animatedTexture = this.createAnimatedTexture(pFrameSize, pOriginalImage.getWidth(), pOriginalImage.getHeight(), p_250432_);
