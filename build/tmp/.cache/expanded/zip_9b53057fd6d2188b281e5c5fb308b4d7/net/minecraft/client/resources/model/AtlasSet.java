...
public class AtlasSet implements AutoCloseable {
   ...
   public Map<ResourceLocation, CompletableFuture<AtlasSet.StitchResult>> scheduleLoad(ResourceManager pResourceManager, int p_251059_, Executor p_250751_) {
      return this.atlases.entrySet().stream().collect(Collectors.toMap(Map.Entry::getKey, (p_261401_) -> {
         ...
         return SpriteLoader.create(atlasset$atlasentry.atlas).loadAndStitch(pResourceManager, atlasset$atlasentry.atlasInfoLocation, p_251059_, p_250751_).thenApply((p_250418_) -> {
