...
public class ChunkPalettedStorageFix extends DataFix {
   ...
   private static void mapSkull(Map<String, Dynamic<?>> pMap, int p_15079_, String pWallId, String p_15081_) {
      pMap.put(p_15079_ + "north", BlockStateData.parse("{Name:'minecraft:" + pWallId + "_wall_" + p_15081_ + "',Properties:{facing:'north'}}"));
      pMap.put(p_15079_ + "east", BlockStateData.parse("{Name:'minecraft:" + pWallId + "_wall_" + p_15081_ + "',Properties:{facing:'east'}}"));
      pMap.put(p_15079_ + "south", BlockStateData.parse("{Name:'minecraft:" + pWallId + "_wall_" + p_15081_ + "',Properties:{facing:'south'}}"));
      pMap.put(p_15079_ + "west", BlockStateData.parse("{Name:'minecraft:" + pWallId + "_wall_" + p_15081_ + "',Properties:{facing:'west'}}"));

      for(int i = 0; i < 16; ++i) {
         pMap.put("" + p_15079_ + i, BlockStateData.parse("{Name:'minecraft:" + pWallId + "_" + p_15081_ + "',Properties:{rotation:'" + i + "'}}"));
      }
   ...
   static class Section {
      ...
      public void setBlock(int p_15203_, Dynamic<?> pDynamic) {
         ...
         this.buffer[p_15203_] = ChunkPalettedStorageFix.idFor(this.palette, pDynamic);
      }
