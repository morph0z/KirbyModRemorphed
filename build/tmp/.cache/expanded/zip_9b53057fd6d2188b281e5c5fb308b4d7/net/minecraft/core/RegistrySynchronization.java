...
public class RegistrySynchronization {
   ...
   private static <E> void put(ImmutableMap.Builder<ResourceKey<? extends Registry<?>>, RegistrySynchronization.NetworkedRegistryData<?>> p_251643_, ResourceKey<? extends Registry<E>> pKey, Codec<E> pNetworkCodec) {
      p_251643_.put(pKey, new RegistrySynchronization.NetworkedRegistryData<>(pKey, pNetworkCodec));
   }
