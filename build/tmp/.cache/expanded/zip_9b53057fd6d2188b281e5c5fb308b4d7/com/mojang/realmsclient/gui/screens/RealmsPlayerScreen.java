...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   class Entry extends ObjectSelectionList.Entry<RealmsPlayerScreen.Entry> {
      ...
      public void render(GuiGraphics pGuiGraphics, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean p_283067_, float pPartialTick) {
         int i;
