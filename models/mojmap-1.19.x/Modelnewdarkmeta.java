...
public class Modelnewdarkmeta<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "newdarkmeta"), "main");
	private final ModelPart right;
	private final ModelPart left;
	private final ModelPart bb_main;

	public Modelnewdarkmeta(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = right.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(32, 57)
						.addBox(17.0F, -8.0F, 5.0F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(36, 53)
		...
		PartDefinition cube_r2 = left.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(32, 57)
						.addBox(-18.0F, -8.0F, 5.0F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(36, 57)
						.addBox(-17.0F, -8.0F, 5.0F, 13.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(36, 53)
						.addBox(-17.0F, -2.0F, 5.0F, 13.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.5236F));
		...
		PartDefinition cube_r5 = bb_main.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(52, 14).addBox(2.5F, -8.5F, -6.3F, 5.0F, 2.0F, 1.0F,
		...
		PartDefinition cube_r7 = bb_main.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(52, 8).addBox(2.3F, -8.6F, -6.3F, 5.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
