...
import com.gmail.jamal009a.kirbymodremorphed.entity.custom.goals.KirbyFollowBuddy;
import com.gmail.jamal009a.kirbymodremorphed.entity.custom.goals.KirbySitGoal;
import com.gmail.jamal009a.kirbymodremorphed.entity.custom.goals.SpecialAnimationGoal;
...
public class KirbyEntity extends AnimatedMob implements OwnableEntity {
    ...
    protected void registerGoals() {
       ...
       //this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 1.2D, false));
        this.goalSelector.addGoal(2, new KirbySitGoal(this));
        this.goalSelector.addGoal(3,  new WaterAvoidingRandomStrollGoal(this, 1.0D));
        this.goalSelector.addGoal(4, new SpecialAnimationGoal(this, 0.5F));
