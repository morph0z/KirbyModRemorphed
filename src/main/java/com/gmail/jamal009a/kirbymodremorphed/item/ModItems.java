...
public class ModItems {
    ...
    public static final RegistryObject<Item> JAMBELIEVER_SPAWN_EGG = ITEMS.register("jambeliever_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.JAMBELIEVER, 0xEE604B, 0xFDD59C, new Item.Properties()));
