...
public class KirbyAbilityAxeItem extends AxeItem {
    public KirbyAbilityAxeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
